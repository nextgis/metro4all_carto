...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [type='secondary_link'] {
    ...
    [bridge=1] { line-color: @secondary_case * 0.8; } //@secondary_case
  }
  [stylegroup='railway'] {
  ...
  [zoom=15] {
    ...
    [stylegroup='service']  { line-width: 0;}//@rdz15_min / 3 + 2; }
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  /* OFF Для мостов - полупрозрачная красная заливка поверх тёмной */
  /* -- colors & styles -- */
  ...
  [zoom=13] {
    ...
    [stylegroup='noauto']   { line-width: 0;}//@rdz13_min / 4; line-dasharray: 1,1; }
  ...
  [zoom=14] {
    ...
    [stylegroup='service']  { line-width: 0;}//@rdz14_min / 3; }
    [stylegroup='noauto']   { line-width: 0;}//@rdz14_min / 4; line-dasharray: 1,1; }
  ...
  [zoom=15] {
    ...
    [stylegroup='service']  { line-width: 0;}//@rdz15_min / 3; }
    [stylegroup='noauto']   { line-width: 0;}//@rdz15_min / 4; line-dasharray: 1,1; }
