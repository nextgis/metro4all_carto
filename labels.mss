...
#area_label {
  //On low levels area labels shown only on water and such stuff
  [zoom>=10][area>102400000],
  //[zoom>=11][area>25600000],
  //[zoom>=13][area>1600000],
  [zoom>=14][area>32000],//32000
  [zoom>=15][area>80000],//80000
  [zoom>=16][area>20000],//20000
  [zoom>=17][area>5000],//5000
  [zoom>=18] 
...
//building addreses  
  ...
  [type='building'][zoom>=16] {
      //this section adds only on buildings
        text-fill: @water * 0.6;
    	text-fill: #888;
